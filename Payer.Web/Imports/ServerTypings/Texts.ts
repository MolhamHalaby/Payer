namespace Payer.Texts {
    ...
    declare namespace Db {
        ...
        namespace Default {
            ...
            namespace Customers {
                export const ClubMember: string;
                export const Id: string;
                export const PersonAddress: string;
                export const PersonBirthday: string;
                export const PersonEmail: string;
            ...
            namespace MailsMessages {
                export const Body: string;
                export const CustomerClubMember: string;
                export const CustomerId: string;
                export const CustomerPersonId: string;
                export const Id: string;
            ...
            namespace Tips {
                ...
                export const Id: string;
                export const Value: string;
                export const WaiterId: string;
                export const WaiterPersonId: string;
                export const WaiterUserId: string;
            }
            ...
            namespace TransactionItems {
                ...
                export const TransactionClosed: string;
                export const TransactionCreated: string;
                export const TransactionCustomerTableId: string;
                export const TransactionDealNum: string;
                export const TransactionId: string;
                export const TransactionItemId: string;
                export const TransactionNoOfCustomers: string;
                export const TransactionQrCode: string;
                export const TransactionWaiterId: string;
            }

            namespace Transactions {
                export const Closed: string;
                export const Created: string;
                export const CustomerTableAccessible: string;
                export const CustomerTableId: string;
                export const CustomerTableNumber: string;
                export const CustomerTablePlaces: string;
                export const DealNum: string;
                export const GenerateQrCode: string;
                export const Id: string;
                export const ItemId: string;
                export const ItemName: string;
                export const ItemPrice: string;
                export const NoOfCustomers: string;
