...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Default
        {
            ...
            public static class CustomerTables
            {
                public const string CustomerTablesIndex = "~/Modules/Default/CustomerTables/CustomerTablesIndex.cshtml";
            }

            public static class Items
            {
                public const string ItemsIndex = "~/Modules/Default/Items/ItemsIndex.cshtml";
            }

            public static class MailsMessages
            {
                public const string MailsMessagesIndex = "~/Modules/Default/MailsMessages/MailsMessagesIndex.cshtml";
            }
            ...
            {
                public const string TipsIndex = "~/Modules/Default/Tips/TipsIndex.cshtml";
            }

            public static class TransactionItems
            {
                public const string TransactionItemsIndex = "~/Modules/Default/TransactionItems/TransactionItemsIndex.cshtml";
            }
            ...
            {
                public const string WaitersIndex = "~/Modules/Default/Waiters/WaitersIndex.cshtml";
            }
        }
